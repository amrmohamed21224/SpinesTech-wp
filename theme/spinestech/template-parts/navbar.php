...
<header id="st-navbar" class="navbar" role="banner" dir="<?php echo esc_attr($dir); ?>">
    <nav class="navbar__inner container" role="navigation" aria-label="<?php echo esc_attr(st_t('nav.mainNav')); ?>">
        ...
        <div class="navbar__menu">
            ...
            ?>
                <a href="<?php echo esc_url(st_url($item['path'])); ?>" class="navbar__link <?php echo esc_attr($cls); ?>"><?php echo esc_html($item['label']); ?></a>
            <?php endforeach; ?>
        </div>
        <div class="navbar__actions">
            ...
            <button type="button" data-st-open-consultation class="navbar__cta button button--primary">
