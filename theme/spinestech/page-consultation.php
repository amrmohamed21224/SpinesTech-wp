        ...
        <div class="page-consultation__grid">
            ...
            <?php if ($locale === 'ar'): ?>
                <div class="page-consultation__seo-text" style="margin-top: 2rem; color: var(--st-color-on-surface-variant); font-size: 0.95rem; line-height: 1.8;">
                    <h2 style="color: var(--st-color-primary); font-size: 1.1rem; font-weight: bold; margin-bottom: 0.5rem;">لماذا تحجز استشارة تقنية مع SpinesTech؟</h2>
                    ...
                    <h2 style="color: var(--st-color-primary); font-size: 1.1rem; font-weight: bold; margin-bottom: 0.5rem;">ماذا تتوقع خلال الجلسة؟</h2>
                    ...
                    <h2 style="color: var(--st-color-primary); font-size: 1.1rem; font-weight: bold; margin-bottom: 0.5rem;">التحضير للجلسة والسرية التامة</h2>
            ...
            <?php else: ?>
                <div class="page-consultation__seo-text" style="margin-top: 2rem; color: var(--st-color-on-surface-variant); font-size: 0.95rem; line-height: 1.8;">
                    <h2 style="color: var(--st-color-primary); font-size: 1.1rem; font-weight: bold; margin-bottom: 0.5rem;">Why book a technical consultation with SpinesTech?</h2>
                    ...
                    <h2 style="color: var(--st-color-primary); font-size: 1.1rem; font-weight: bold; margin-bottom: 0.5rem;">What to expect during the session?</h2>
                    ...
                    <h2 style="color: var(--st-color-primary); font-size: 1.1rem; font-weight: bold; margin-bottom: 0.5rem;">Preparation & Confidentiality</h2>
