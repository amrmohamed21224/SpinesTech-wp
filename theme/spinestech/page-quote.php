    ...
    <div class="max-w-container-max mx-auto grid lg:grid-cols-3 gap-8">
        <div class="lg:col-span-2 space-y-8">
            <section class="p-8 bg-white border border-outline-variant/30 rounded-2xl">
                <h2 class="text-headline-sm font-bold text-primary mb-4"><?php echo $locale === 'ar' ? '1. Ø§Ø®ØªØ± Ø§Ù„Ø®Ø¯Ù…Ø©' : '1. Choose service'; ?></h2>
            ...
            <section class="p-8 bg-white border border-outline-variant/30 rounded-2xl">
                <h2 class="text-headline-sm font-bold text-primary mb-4"><?php echo $locale === 'ar' ? '2. Ù†Ø·Ø§Ù‚ Ø§Ù„Ù…ÙŠØ²Ø§Ù†ÙŠØ©' : '2. Budget range'; ?></h2>
        ...
        <aside class="p-8 bg-surface-container-low rounded-2xl border border-outline-variant/20 h-fit sticky top-28">
            ...
            <form data-st-quote-form class="space-y-4">
                <h2 class="text-headline-sm font-bold text-primary"><?php echo $locale === 'ar' ? '3. Ø¨ÙŠØ§Ù†Ø§ØªÙƒ' : '3. Your details'; ?></h2>
                ...
                <textarea required name="details" rows="4" placeholder="<?php echo $locale === 'ar' ? 'ØµÙ Ù…Ø´Ø±ÙˆØ¹Ùƒ' : 'Describe your project'; ?>" class="w-full px-4 py-3 rounded-xl border border-outline-variant/40 bg-white outline-none resize-y"></textarea>
